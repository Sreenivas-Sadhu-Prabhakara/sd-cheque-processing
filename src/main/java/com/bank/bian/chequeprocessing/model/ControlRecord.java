package com.bank.bian.chequeprocessing.model;
...
/**
 * The BIAN control record for this service domain: "Cheque Transaction Procedure".
 *
 ...
 * to its asset type (Cheque Transaction). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Cheque Transaction Procedure";
